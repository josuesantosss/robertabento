(function() {
            ...
            if (result.success && result.clientes && result.clientes.length > 0) {
                ...
                if (clientesFiltrados.length > 0) {
                    ...
                    clientesFiltrados.forEach(cliente => {
                        ...
                        html += `
                            <tr onclick="window.mostrarDetalhesCliente('${nomeSafe}')" style="cursor:pointer;" onmouseover="this.style.background='#f7fafc'" onmouseout="this.style.background='white'">
    ...
    // ============================================================
    // VENDEDORA - SEM BARRA DE ROLAGEM
    // ============================================================
        ...
        app.innerHTML = `
            <section>
                ...
                <div style="background: white; padding: 30px; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                    ...
                    <!-- DIV COM TODOS OS PENDENTES (HOJE + ATRASO) - SEM BARRA DE ROLAGEM -->
    ...
    // ============================================================
    // CARREGAR PROMESSAS - SEM BARRA DE ROLAGEM
    // ============================================================
    ...
    console.log('🚀 Sistema de Vendas v7.0 - Sem barras de rolagem');
})();